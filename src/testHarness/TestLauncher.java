 ...
 *
 * 1. Launch the application. 2. Pass the stage to TestHarness, which handles
 * changing views. 3. Pass the view associated with the first test to
 * TestHarness, which then loads the view and its controller.
 *
 * @author jsm158
 */
